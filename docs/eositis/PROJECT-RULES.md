...
- macOS CYW43 internet: `-wifi -tap` uses utun; see `docs/eositis/MACOS-WIFI.md`. Guest lwIP/cyw43_arch owns DNS/NTP through the emulated radio (not MegaFlash host traps).
