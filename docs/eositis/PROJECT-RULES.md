...
- macOS CYW43 internet: `-wifi -tap` uses utun; see `docs/eositis/MACOS-WIFI.md`. MegaFlash TestWifi uses host DNS/NTP probes (guest CYW43 init stays stubbed for BusLoop).
